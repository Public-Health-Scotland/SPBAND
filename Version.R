...
`Version` <- c("1.10", "1.9", "1.8", "1.7", "1.6", "1.5", "1.4", "1.3", "1.2", "1.1", "1.0")
`Date` <- c("7 Apr 2026", "20 Jan 2026", "9 Oct 2025", "7 Oct 2025", "14 Jan 2025", "1 Oct 2024", "2 Jul 2024", "2 Apr 2024", "15 Feb 2024", "9 Nov 2023", "3 Oct 2023")
`Change` <- c("Added a new measure in the ‘Neonatal’ category - ‘Admissions to a specialist neonatal unit by highest level of care’. This measure is a new developmental presentation based on specifications from the National Neonatal Network Data group. The data is sourced from the NeoCareIn+ dataset and SMR02. Please contact phs.matneodatahub@phs.scot for more information or to provide feedback.",
              "Added a measure in a new ‘Neonatal’ category - ‘Median corrected gestational age at discharge from specialist neonatal care for babies born at 30-32 weeks gestation’. This measure is a new developmental presentation based on specifications from the National Neonatal Network Data group. The data is sourced from the NeoCareIn+ dataset. Please contact phs.matneodatahub@phs.scot for more information or to provide feedback.",
              "Added page about the MatNeo Data Hub with links to access other MatNeo data for Scotland. Available through the MatNeo Data Hub link in the left-hand menu.",
